...
welcome_label = Label(text='Welcome to Deez Nuts', bg='black', font=("arial", 15, "bold"), fg='white')
welcome_label.place(x=200, y=10)

created_by_label = Label(text='Created By Deep and Akash', bg='black', font=("arial", 15, "bold"), fg='white')
created_by_label.place(x=170, y=50)

progress_label = Label(root, text="Loading...", font=('arial', 13, 'bold'), fg='white', bg='black')
